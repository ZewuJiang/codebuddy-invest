...
# 投研鸭小程序数据生产 — 标准工作流 v11.4

> **版本**: v11.4 (2026-05-03) — 彻底移除公开API同步模块（GitHub Pages/EdgeOne/ClawHub），数据链路简化为微信云数据库唯一分发通道
> **上一版本**: v11.3 (2026-04-21 21:40) — 全面细节审查：13处版本/数据不一致修复+前端代码清洁+ARK数据源URL修正
