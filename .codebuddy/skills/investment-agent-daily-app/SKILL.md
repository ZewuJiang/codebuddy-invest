...
# 投研鸭小程序数据生产 — 标准工作流 v10.0

> **版本**: v10.0 (2026-04-08 17:30) — Harness v10.0 工具链全面升级：AI 只做搜索+写分析，其余全自动
> **主控文档**：本文件为精炼主控（≤250行），详细规则通过引用按需加载。
> **核心改造**：①auto_compute.py v2.0（接管 metrics[2-5]+gics排序+dataTime+sourceType）②validate.py v4.0（+V30-V34内容质量层）③checklist_generator.py（执行前自动清单）④post_flight.py（执行后自动报告）⑤schema-compact.json（AI紧凑参照）
...
| 已知堵点条数 | 40（活跃） | 2026-04-08 |
| trafficLights 阈值版本 | v4.8 | 2026-04-05 |
| 上次月度审计 | 未执行 | — |
| 连续零事故天数 | 0 | 2026-04-08 |
| 回归门禁条数 | 9 (R1-R9, 含3项FATAL) + V39 FATAL | 2026-04-08 |
| 持仓缓存版本 | v1.1 (2025Q4 13F 已修正) | 2026-04-08 |
| **validate.py 版本** | **v5.1 (45项 含V39聪明钱13F合规性FATAL)** | **2026-04-08** |
| **auto_compute.py 版本** | **v2.0 (12类字段自动计算)** | **2026-04-08** |
